...
// GET /api/produtos/[id]/grade - Buscar grade completa do produto
export async function GET(
  request: NextRequest,
  { params }: { params: { id: string } }
) {
  try {
    console.log('🔍 API GET /api/produtos/[id]/grade chamada');
    console.log('📝 ID do produto:', params.id);
    
    const codigoInterno = parseInt(params.id);
...
// POST /api/produtos/[id]/grade - Salvar/atualizar grade do produto
export async function POST(
  request: NextRequest,
  { params }: { params: { id: string } }
) {
  try {
    console.log('💾 API POST /api/produtos/[id]/grade chamada');
    console.log('📝 ID do produto:', params.id);
...
// DELETE /api/produtos/[id]/grade - Remover variante específica da grade
export async function DELETE(
  request: NextRequest,
  { params }: { params: { id: string } }
) {
  try {
    console.log('🗑️ API DELETE /api/produtos/[id]/grade chamada');
