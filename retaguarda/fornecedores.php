...
<?php include ("fornecedores_class.php");?> 
<script type="text/javascript" src="js/fornecedores.js"></script>
<body>
	<div class="container" id="fornecedor_principal">
		<br>
		<div class="row">
			...
			<div class="col s6">
				<a class="btn-floating btn-small waves-effect yellow"
					...
					onClick='cadastro_fornecedor(0)' id='but_add'><i
	...
	<div class="container" id="fornecedor_cadastro">
		<form action="#">
				...
				<li>
					...
					<div class="collapsible-body">
						<div class="row">
							...
							<div class="input-field col s12 l8">
								<input type="text" class="input-field" placeholder=""
									id="fantasia" /><label class="active"  class="active"  for="fantasia">Fantasia</label>
							</div>
						...
						<div class="row">
							<div class="input-field col s12 l6">
								<input type="text" class="input-field" placeholder=""
									id="comprador" /><label class="active"  for="comprador">Comprador</label>
							</div>
						...
						<div class="row">
							...
							<div class="input-field col s6 l6">
								<input type="date"  class="datepicker activ" placeholder="" id="dt_inicio" /><label class="active" 
									for="dt_inicio">Nascimento</label>
							</div>
			...
			<div class="row"> 
				<div class="col s12 l4">
					<a class="waves-effect waves-light btn red"
						href="javascript:limparFornecedor()">Limpar</a>
				</div>
				<div class="col s12 l4">
					<a href="javascript:gravarFornecedores()"
