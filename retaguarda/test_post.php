<?php
/**
 * Teste direto de POST para export_product.php
 */
...
// Configurar cURL
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://249fafeab50f.ngrok-free.app/retaguarda/mercadolivre/export_product.php');
...
// Executar
echo "Enviando POST para export_product.php...\n";
echo "URL: https://249fafeab50f.ngrok-free.app/retaguarda/mercadolivre/export_product.php\n";
echo "Data: " . $postString . "\n\n";
