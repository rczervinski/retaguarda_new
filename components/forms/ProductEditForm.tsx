    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {renderSection('🖼️ IMAGENS', 'imagens', (
        <div className="space-y-8">
          ...
          {/* Upload com Preview */}
          {renderSubsection('📸 Upload e Preview', (
            <>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                              ...
                              if (files && files.length > 0) {
                                for (let i = 0; i < files.length; i++) {
                                  ...
                                  reader.onload = (event) => {
                                    ...
                                    // Aqui implementaria a lógica de preview
                                    const preview = document.getElementById('image-preview');
                                    if (preview) {
                                      preview.innerHTML = `
                                        <div class="relative">
                                          <img src="${img}" alt="Preview" class="w-full h-64 object-cover rounded-lg" />
                                          <div class="absolute top-2 right-2">
                                            <button type="button" class="bg-red-500 text-white p-1 rounded-full text-xs hover:bg-red-600">
                                              🗑️
                                            </button>
                                          </div>
                                        </div>
                  ...
                  <div className="mt-4">
                    <label htmlFor="imagem_principal" className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="text-sm font-medium text-gray-700 mb-3">Preview da Imagem</h4>
                    <div id="image-preview" className="min-h-64 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg">
          ...
          {renderSubsection('⚙️ Redimensionamento e Crop', (
            <>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label htmlFor="redimensionar_imagem" className="block text-sm font-medium text-gray-700 mb-1">
                    Redimensionar Para
                  </label>
                  <select
                    id="redimensionar_imagem"
                    name="redimensionar_imagem"
                    value={formData.redimensionar_imagem || 'nao'}
                    onChange={handleInputChange}
                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 sm:text-sm"
                  >
                    <option value="nao">Não redimensionar</option>
                    <option value="800x600">800x600px</option>
                    <option value="1024x768">1024x768px</option>
                    <option value="1200x900">1200x900px</option>
                    <option value="customizado">Tamanho customizado</option>
                  </select>
                </div>
                ...
                <div className="flex items-center">
                  <input
                    id="gerar_thumbnail"
                    name="gerar_thumbnail"
                    type="checkbox"
                    checked={Boolean(formData.gerar_thumbnail)}
                    onChange={handleInputChange}
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="gerar_thumbnail" className="ml-2 block text-sm text-gray-900">
                ...
                <div className="flex justify-end">
                  <button
                    type="button"
                    onClick={() => {
                      // Implementar modal de crop
                      alert('Funcionalidade de crop dinâmico será implementada aqui');
                    }}
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-blue-800">
                      Funcionalidade de Crop Dinâmico
                    </h3>
                    <div className="mt-2 text-sm text-blue-700">
                      <p>
                        • Selecione uma imagem acima para ver o preview<br/>
                        • Use "Recortar Imagem" para abrir editor de crop<br/>
                        • Escolha a área desejada antes de salvar<br/>
                        • Preview em tempo real das dimensões selecionadas
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {renderSubsection('🖼️ Galeria', (
            <>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        type="button"
                        onClick={() => {
                          setFormData(prev => ({ ...prev, imagem_principal: '' }));
                        }}
                ...
                <div className="aspect-square bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors cursor-pointer">
              ...
              <div className="mt-4 text-sm text-gray-500">
                💡 Dica: A primeira imagem será considerada como imagem principal do produto.
              </div>
            </>
          ))}
        </div>
